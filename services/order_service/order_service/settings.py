...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-order-service-key')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'False') == 'True'

ALLOWED_HOSTS = ['*', 'localhost', 'order_service', 'order_service:8000']
...
LOGGING = {
    ...
    'loggers': {
        '': {  # Root logger, áp dụng cho tất cả module
            'handlers': ['console'],
            'level': 'DEBUG',  # Hiển thị từ DEBUG trở lên
            'propagate': False,
        },
    },
}
